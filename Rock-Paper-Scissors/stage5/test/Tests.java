...
public class Tests extends StageTest<String> {
  ...
  public List<TestCase<String>> generate(){
    ...
    String[] options = "rock,gun,lightning,devil,dragon,water,air,paper,sponge,wolf,tree,human,snake,scissors,fire".split(
            ",");
  ...
  CheckResult checkAdvanced(String reply, String attach){
    ...
    List<String> options = Arrays.stream("rock,gun,lightning,devil,dragon,water,air,paper,sponge,wolf,tree,human,snake,scissors,fire".split(",")).collect(Collectors.toList());
